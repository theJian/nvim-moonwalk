...
test('RGB to LAB', function()
  ...
  expect(
    string.format('White Lab: L=%.2f, a=%.2f, b=%.2f', white_lab[1], math.abs(white_lab[2]), math.abs(white_lab[3]))
  ).toBe 'White Lab: L=100.00, a=0.00, b=0.00'

  local red_rgb = { 255, 0, 0 }
  local red_lab = rgb_to_lab(red_rgb)
  expect(string.format('Red Lab: L=%.2f, a=%.2f, b=%.2f', red_lab[1], red_lab[2], red_lab[3])).toBe 'Red Lab: L=53.24, a=80.09, b=67.20'
end)
